...
-- Buffers
vim.keymap.set("n", "<D-t>", util.cmd("enew"))

-- Tabs
vim.keymap.set("n", "<D-1>", util.cmd('exec "normal! 1gt"'))
vim.keymap.set("n", "<D-2>", util.cmd('exec "normal! 2gt"'))
vim.keymap.set("n", "<D-3>", util.cmd('exec "normal! 3gt"'))
vim.keymap.set("n", "<D-4>", util.cmd('exec "normal! 4gt"'))
vim.keymap.set("n", "<D-5>", util.cmd('exec "normal! 5gt"'))
vim.keymap.set("n", "<D-6>", util.cmd('exec "normal! 6gt"'))
vim.keymap.set("n", "<D-7>", util.cmd('exec "normal! 7gt"'))
vim.keymap.set("n", "<D-8>", util.cmd('exec "normal! 8gt"'))
vim.keymap.set("n", "<D-9>", util.cmd('exec "normal! 9gt"'))
